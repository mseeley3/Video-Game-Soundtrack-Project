...
Therefore while it is recommended for game developers creating higher budget to invest a little in to their soundtracks in order to create a polished piece of work, indie developers simiply should create a soundtrack that isn't distracting. 
